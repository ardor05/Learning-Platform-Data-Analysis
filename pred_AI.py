...
def app():
    # Load the dataset
    file_path = r'C:/Users/ACER/Downloads/capstone/cleaned_logs_AI1.0.csv'
    ...
    **Cluster Distribution:**
    ...
    - **Cluster 1 (Teal):** Represents days with moderate activity counts. These dots are spread out more along the y-axis, indicating a moderate level of student activity.
